		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commindsetappsproject6-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetappsproject6-display": {
								"semanticObject": "commindsetappsproject6",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.apps.project6",
									"url": sap.ui.require.toUrl("com/mindset/apps/project6")
								}
							}
						}
					}
